...
def calcular_enlaces_hidrogeno(pdb_file,xtc_file):
    ...
    hbonds = HBA(universe=u,donors_sel='name O or name N',hydrogens_sel='name H or name HN',acceptors_sel='name O or name N',d_a_cutoff=3.6,d_h_a_angle_cutoff=150,d_h_cutoff=1.8)
    hbonds.run()
